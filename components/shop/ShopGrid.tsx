...
/**
 * ShopGrid
 * Grille produits + tri + filtres auxiliaires.
 * La navigation par collection se fait via <CollectionGrid> ou les pills de sous-collection
 * sur les pages [category] et [category]/[sub] — pas ici.
 */
