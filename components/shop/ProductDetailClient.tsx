...
export default function ProductDetailClient({ product, related }: Props) {
  ...
  // Sticky CTA bar appears after main CTA scrolls out of view
  useEffect(() => {
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div>
          ...
          <div className="mb-5">
            {isOutOfStock ? (
              <p className="text-sm font-sans text-red-500 flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-red-500 inline-block" />
                Rupture de stock
              </p>
            ) : isLow ? (
              <p className="text-sm font-sans text-amber-600 flex items-center gap-1.5">
          ...
          {/* Social proof nudge */}
          <p className="text-xs text-zen-muted mb-5 flex items-center gap-1">
            <Eye size={12} className="text-zen-terracotta" />
            <span>42 personnes regardent ce produit en ce moment</span>
          </p>
