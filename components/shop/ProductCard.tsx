  ...
  return (
    <div className="group lift rounded-2xl overflow-hidden cursor-pointer"
      ...
      <div className="p-5 lg:p-6">
        {/* Contrast fix: #6B5C55 instead of #9a8878 for category label */}
        <p className="text-[10px] font-sans uppercase tracking-widest mb-2"
        ...
        <div className="flex items-baseline gap-2">
          <span className="font-sans font-bold text-xl" style={{ color: isOutOfStock ? '#6B5C55' : '#2C2420' }}>
            {product.retailPriceEur} €
          </span>
          {product.compareAtPriceEur && (
            <span className="text-sm line-through" style={{ color: '#6B5C55' }}>{product.compareAtPriceEur} €</span>
          )}
        </div>
      </div>
    </div>
