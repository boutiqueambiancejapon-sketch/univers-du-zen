            ...
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50">
                {['Commande', 'Client', 'Date', 'Statut', 'Total', 'Fournisseur', 'Action'].map(h => (
                  <th key={h} className="text-left px-4 py-3 text-[11px] font-semibold uppercase tracking-wider text-gray-400">{h}</th>
                ))}
              </tr>
            </thead>
                ...
                return (
                  <tr key={o.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      ...
                      <p className="text-[10px] text-gray-400">{o.country_code}</p>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      {result && (
                        <p className={`text-[10px] mb-1 ${result.ok ? 'text-emerald-600' : 'text-red-500'}`}>
                      ...
                      {canPush ? (
                        <button onClick={() => pushOrder(o.id)} disabled={pushing === o.id}
                          className="flex items-center gap-1.5 text-[11px] font-semibold bg-gray-900 text-white px-3 py-1.5 rounded-lg hover:bg-gray-700 transition-colors disabled:opacity-50">
                        ...
                        <span className="text-[10px] text-gray-400">Déjà envoyée</span>
                      ) : null}
                    </td>
                  </tr>
                );
